...
HD_PWD='Z:/jbattista20/CS-401-1-CompArch/Lab01/ourAlu/ourAlu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nBitAlu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nBitAlu.tcl -notrace
