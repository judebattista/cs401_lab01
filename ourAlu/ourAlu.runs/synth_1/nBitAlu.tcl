...
read_vhdl -library xil_defaultlib Z:/jbattista20/CS-401-1-CompArch/Lab01/ourAlu/ourAlu.srcs/sources_1/new/nBitAlu.vhd
...
synth_design -top nBitAlu -part xc7a100tcsg324-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef nBitAlu.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file nBitAlu_utilization_synth.rpt -pb nBitAlu_utilization_synth.pb"
